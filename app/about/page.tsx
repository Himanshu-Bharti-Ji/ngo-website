      ...
      <section className="bg-[#0d2b1a] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-slate-100">
            ...
            <ul className="space-y-2">
              <li>
                • Registration under Section 12(A) of Income Tax Act 1961
                (1998–99)
              </li>
              <li>• 12(A) Registration renewed and valid up to AY 2036–37</li>
              <li>• PAN No. AAAA2009D</li>
              <li>
                • Renewed FCRA certificate valid from 01/04/2023 to 31/12/2028
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">
                Youth &amp; children (0–18 years)
              </h3>
              <p className="text-sm text-gray-700">
                Protecting and educating children through Bridge Course Camps,
                learning centres and CHILDLINE services.
              </p>
            </div>
            <div className="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-6">
              <div className="w-9 h-9 rounded-xl bg-emerald-600 text-white flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-700">
                Minority girls, Mahila Mandals and women&apos;s Self Help Groups
                building voice, health and livelihoods.
              </p>
            </div>
            <div className="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-6">
              <div className="w-9 h-9 rounded-xl bg-emerald-600 text-white flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-700">
                Dalit communities and leprosy‑affected families facing
                exclusion, stigma and multiple deprivations.
              </p>
            </div>
            <div className="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-6">
              <div className="w-9 h-9 rounded-xl bg-emerald-600 text-white flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-700">
                Small and marginal farmers adopting sustainable agriculture and
                low‑cost Packages of Practices (PoPs).
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div>
              ...
              <h2
                ...
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                Rooted in West Champaran,
                <br />
                connected to the border region.
              </h2>
              <ul className="space-y-2 text-sm text-gray-800">
                <li>
                  <strong>West Champaran district:</strong> approx. 5,225 sq.
                  km, with about 3,000 sq. km plains area.
                </li>
                <li>
                  <strong>Established as a district:</strong> 1972.
                </li>
                <li>
                  <strong>Surrounded by:</strong> Nepal (North), Gopalganj
                  (South), East Champaran (East), Uttar Pradesh (West).
                </li>
                <li>
                  <strong>Main areas of operation:</strong> West Champaran, East
                  Champaran and Sitamarhi districts of Bihar; Nepal‑bordering
                  districts of Eastern Uttar Pradesh.
                </li>
                <li>
                  <strong>Infrastructure:</strong> Jan Vikas owns 0.35 acres of
                  land in Pathkhauli village with a well‑furnished building used
                  for innovative schooling and agricultural projects.
                </li>
              </ul>
            </div>
            <IndiaOperationsMap />
          ...
          <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.4fr)] gap-10 items-center">
              ...
              <div className="rounded-3xl overflow-hidden border border-emerald-500/40 bg-gradient-to-b from-emerald-500/20 to-slate-900 shadow-xl">
                {/* <div className="h-72 sm:h-80 overflow-hidden">
                  <img
                    ...
                    className="w-full h-full object-cover object-top-left scale-125"
                  />
                </div> */}
                <div className="rounded-3xl overflow-hidden shadow-2xl shadow-emerald-900/60 border border-emerald-700/40">
                  <img
                    ...
                    alt="President of Jan Vikas"
                    className="w-full h-[420px] sm:h-[360px] object-cover object-top-left scale-125"
                  />
                </div>
                <div className="p-6 sm:p-7">
                  ...
                  <p className="text-xs text-slate-400">
                    Around 34 years of experience in social service and
                    development.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="text-slate-100 text-sm leading-relaxed mb-4">
                The president of Jan Vikas, Mr. A. Majeed, is a qualified,
                popular and experienced personality in the field of social work.
                He has around 34 years of experience in different development
                sectors such as education, economic planning, social
                organisation, integrated development and livelihood development.
              </p>
              <p className="text-slate-100 text-sm leading-relaxed mb-4">
                He has worked as Programme Officer, Coordinator, Resource Person
                and Consultant in several prestigious organisations including
                IGSSS, NEG, D.K. Austria, Development Alternatives, PACS and
                SDTT. These engagements have strengthened his understanding of
                grassroots realities as well as programme management.
              </p>
              <p className="text-slate-100 text-sm leading-relaxed">
                Mr. Majeed is known for his ability to work with teams in a
                spirit of commitment and shared leadership. His approach is
                result‑oriented while being rooted in values of justice and
                dignity — qualities that continue to guide the work of Jan Vikas
                today.
              </p>
            </div>
          </div>
