    ...
    <>
      ...
      <section className="bg-[#0d2b1a] py-4 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-300/60 whitespace-nowrap">
            Our focus
          </p>
          <div className="flex flex-wrap justify-center gap-2">
            {[
              ...
              "Women & Child Health",
              "Women’s Livelihoods & SHGs",
              "Community Dev",
              "Environment",
            ].map((t) => (
              <span
                key={t}
                className="text-xs font-medium text-emerald-100/70 border border-emerald-400/20 rounded-full px-3 py-1"
              >
                {t}
              </span>
            ))}
          ...
          <Link
            href="/what-we-do"
            className="hidden sm:flex items-center gap-1 text-xs font-semibold text-emerald-300 hover:text-white transition-colors whitespace-nowrap"
          >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <h2
                className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1a1208] leading-tight mb-5"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                Every number
                <br />
                <em className="text-emerald-700">tells a story.</em>
              </h2>
              <p className="text-gray-600 text-base leading-relaxed mb-7">
                Behind every statistic is a child who learned to read, a mother
                who received prenatal care, a family that found economic
                stability.
              </p>
              <Link
                href="/impact"
                className="inline-flex items-center gap-2 text-sm font-semibold text-emerald-700 border-b-2 border-emerald-600 pb-0.5 hover:text-emerald-900 transition-colors"
              >
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {impactStats.map((stat, i) => (
                <div
                  key={stat.label}
                  className={`rounded-2xl p-5 sm:p-6 ${i === 0 ? "bg-[#0d2b1a]" : i === 1 ? "bg-emerald-600" : i === 2 ? "bg-amber-50 border border-amber-200" : "bg-white border border-gray-200"}`}
                >
                  <p
                    className={`text-3xl sm:text-4xl font-bold mb-1 ${i < 2 ? "text-white" : "text-[#0d2b1a]"}`}
                  >
                    {stat.number}
                  </p>
                  <p
                    className={`text-xs sm:text-sm font-medium ${i < 2 ? "text-white/70" : "text-gray-600"}`}
                  >
                    {stat.label}
                  </p>
                </div>
      ...
      <section className="bg-[#1a1208] py-3 overflow-hidden">
        <div className="marquee-track gap-2 px-2">
          {[...photoStrip, ...photoStrip].map((src, i) => (
            <div
              key={i}
              className="flex-shrink-0 w-52 sm:w-64 h-32 sm:h-40 rounded-xl overflow-hidden"
            >
              <img
                src={src}
                alt=""
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 sm:mb-14">
            <div>
              ...
              <div className="w-10 h-0.5 bg-gradient-to-r from-amber-500 to-amber-300 rounded-full mb-6" />
              <h2
                className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1a1208] leading-tight"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                Three pillars.
                <br />
                <em className="text-emerald-700">One mission.</em>
              </h2>
            </div>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/what-we-do"
              className="inline-flex items-center gap-2 px-7 py-3 rounded-full border-2 border-[#0d2b1a] text-[#0d2b1a] font-semibold text-sm hover:bg-[#0d2b1a] hover:text-white transition-all"
            >
      ...
      {/* <section className="relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-[#0d2b1a] flex flex-col justify-center p-8 sm:p-12 lg:p-16">
            ...
            <p
              className="text-white text-xl sm:text-2xl lg:text-3xl leading-relaxed mb-7"
              style={{
            ...
            <Link
              href="/impact"
              className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-emerald-300 hover:text-white transition-colors"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10 sm:mb-12">
            ...
            <div className="hidden md:flex gap-2">
              ...
              <button
                onClick={() =>
                  setActiveStory(
                    Math.min(impactStories.length - 1, activeStory + 1),
                  )
                }
                className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-[#0d2b1a] hover:text-white hover:border-[#0d2b1a] transition-all"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {impactStories.map((story, i) => (
              <div
                key={i}
                className={`rounded-2xl sm:rounded-3xl overflow-hidden transition-all duration-300 cursor-pointer ${i === activeStory ? "ring-2 ring-emerald-500 scale-[1.02]" : "opacity-80 hover:opacity-100"}`}
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute bottom-3 left-3">
                    <span className="inline-block text-[10px] font-bold uppercase tracking-wider bg-amber-500 text-white rounded-full px-2.5 py-0.5">
                      {story.program}
                    </span>
                  </div>
                </div>
                <div className="bg-white p-4 sm:p-5">
                  ...
                  <p className="text-sm text-gray-700 italic leading-relaxed mb-3 line-clamp-3">
                    "{story.quote}"
                  </p>
                  <div className="flex items-center gap-1.5 text-xs text-gray-500 flex-wrap">
                    <span className="font-bold text-[#0d2b1a]">
                      {story.name}
                    </span>
                    <span>·</span>
                    <MapPin size={11} />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-3 auto-rows-[140px] sm:auto-rows-[165px] md:auto-rows-[180px]">
            {homeGalleryImages.map((img, idx) => (
              <button
                ...
                className={`group relative overflow-hidden rounded-xl sm:rounded-2xl ${img.span} cursor-pointer`}
              >
                <img
                  src={img.src}
                  alt={img.alt}
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5 mb-10 sm:mb-12">
            <div>
              ...
              >
                See the impact
                <br />
                <em className="text-emerald-700">you make.</em>
              </h2>
            </div>
            <Link
              href="/media"
            ...
            {homeVideos.map((video, idx) => (
              ...
              >
                <div className="relative h-44 sm:h-48 overflow-hidden">
                  ...
                  <span className="absolute top-3 left-3 text-[10px] font-bold bg-amber-500 text-white rounded-full px-2 py-0.5">
                    {video.label}
                  </span>
                </div>
                <div className="p-4 bg-gray-50">
                  <p className="text-sm font-semibold text-[#1a1208] line-clamp-2">
                    {video.title}
                  </p>
                </div>
              </button>
      ...
      {/* <section className="py-16 sm:py-20 bg-amber-50 border-y border-amber-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p
            className="text-xl sm:text-2xl lg:text-3xl text-[#1a1208] mb-7"
            style={{
              fontFamily: "'Playfair Display', serif",
              fontStyle: "italic",
            }}
              ...
              >
                <div className="relative h-48 sm:h-52 overflow-hidden">
                  <img
                    ...
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                  <span className="absolute top-4 left-4 text-xs font-bold bg-amber-500 text-white rounded-full px-3 py-1">
                    {item.category}
                  </span>
                </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              Your support
              <br />
              <em className="text-emerald-400">changes everything.</em>
            </h2>
            <p className="text-slate-300 max-w-xl mx-auto text-sm sm:text-base">
              There are many ways to walk alongside the communities we serve.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Donate",
                desc: "Even ₹100 provides meals for 5 children. Every rupee reaches the community directly.",
                cta: "Make a donation",
                href: "/get-involved",
              },
              {
                ...
                color: "bg-amber-500",
                title: "Volunteer",
                desc: "Teach, assist in health camps, or support operations. Your skills can transform lives.",
              ...
              },
              {
                ...
                color: "bg-[#1a5c3a]",
                title: "Partner",
                desc: "CSR partnerships, corporate volunteering, and institutional collaborations.",
              ...
              <div
                key={card.title}
                className="bg-white/5 border border-white/10 rounded-2xl sm:rounded-3xl p-7 hover:bg-white/10 transition-all group"
              >
                <div
                  className={`w-12 h-12 ${card.color} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform`}
                >
                  {card.icon}
                </div>
                <h3
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${NGO.sewingCertificates})`,
      ...
      >
        ...
        <div className="relative flex flex-col justify-center min-h-[320px] sm:min-h-[380px] py-16">
          <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 w-full">
            ...
            <h2
              className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 max-w-xl leading-tight"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              Your support can
              <br />
            ...
            <p className="text-slate-300 mb-8 max-w-md text-sm sm:text-base">
              Partner with us as a donor, volunteer, or community champion and
              help us reach the next 50,000 lives.
            </p>
            <Link
              href="/get-involved"
      ...
      {selectedImage !== null && (
        ...
        >
          ...
          >
            ...
            <img
              src={homeGalleryImages[selectedImage].src}
              alt={homeGalleryImages[selectedImage].alt}
              className="w-full max-h-[72vh] object-contain rounded-2xl"
            />
            <div className="mt-3 flex items-center justify-between px-1">
              <p className="text-xs sm:text-sm text-white/70">
                {homeGalleryImages[selectedImage].alt}
              </p>
              <span className="text-emerald-400 text-xs font-semibold">
                {homeGalleryImages[selectedImage].label}
              </span>
            </div>
            <div className="flex justify-center gap-3 mt-4">
              <button
                ...
                className="px-4 sm:px-5 py-2 bg-white/10 hover:bg-white/20 text-white rounded-full text-sm font-medium flex items-center gap-1"
              >
                <ChevronLeft size={15} />
                Prev
              </button>
              <button
                onClick={() =>
                  setSelectedImage(
                    (selectedImage + 1) % homeGalleryImages.length,
                  )
                }
                className="px-4 sm:px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full text-sm font-medium flex items-center gap-1"
              >
                Next
            ...
            <div className="rounded-2xl overflow-hidden bg-black">
              <div className="aspect-video">
                <iframe
                  ...
                  src={homeVideos[selectedVideo].url}
                  title={homeVideos[selectedVideo].title}
              ...
              <div className="p-4 sm:p-5 bg-[#0d2b1a]">
                <p className="text-xs font-bold uppercase tracking-wider text-emerald-300 mb-1">
                  {homeVideos[selectedVideo].label}
                </p>
                <p className="font-semibold text-white text-sm sm:text-base">
                  {homeVideos[selectedVideo].title}
                </p>
              </div>
            </div>
          </div>
