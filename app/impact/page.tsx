      ...
      <section className="bg-[#0d2b1a] py-14 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-300/60 mb-3">
              Our achievements
            </p>
            <h2
            ...
            >
              The numbers behind{" "}
              <em className="text-emerald-400">the mission.</em>
            </h2>
          </div>
              ...
              >
                ...
                <div className="absolute inset-0 p-6 sm:p-7 flex flex-col justify-end">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="text-base sm:text-lg font-bold text-emerald-300 uppercase tracking-wider text-sm">
                      {byNumbersLabels[i]}
                    </h4>
                  </div>
