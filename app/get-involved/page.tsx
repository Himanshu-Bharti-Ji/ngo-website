...
export default function GetInvolved() {
  ...
  const { hero, donationImpact, volunteerOpportunities, partnershipTypes } =
    getInvolvedContent;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
              ...
              <div>
                ...
                >
                  Every rupee
                  <br />
                  <em className="text-emerald-700">reaches a life.</em>
                </h2>
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Your donation directly impacts thousands. Whether a one-time
                  contribution or a monthly commitment, every amount creates
                  real change.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                  {donationImpact.map((item, i) => (
                    <div
                      key={i}
                      className={`rounded-2xl p-4 border ${i === 0 ? "bg-[#0d2b1a] border-[#0d2b1a]" : i === 1 ? "bg-emerald-600 border-emerald-600" : "bg-white border-gray-200"}`}
                    >
                      <p
                        className={`text-xl font-bold mb-1 ${i < 2 ? "text-white" : "text-emerald-700"}`}
                      >
                        {item.amount}
                      </p>
                      <p
                        className={`text-xs leading-relaxed ${i < 2 ? "text-white/70" : "text-gray-600"}`}
                      >
                        {item.text}
                      </p>
                    </div>
              ...
              <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl">
                <img
                  ...
                  alt="Why donate"
                  className="w-full h-72 sm:h-80 lg:h-full min-h-[300px] object-cover"
                />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  ...
                  <ul className="space-y-3">
                    {[
                      {
                        label: "Transparent",
                        desc: "Complete transparency in fund utilization",
                      },
                      {
                        label: "Impact Driven",
                        desc: "Every rupee creates maximum social impact",
                      },
                      {
                        label: "Tax Benefits",
                        desc: "Registered 80G NGO — donations are tax deductible",
                      },
                      {
                        label: "Regular Updates",
                        desc: "Updates on how your donation is making a difference",
                      },
                    ].map((item, i) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div>
                <p className="text-gray-600 mb-7 leading-relaxed">
                  Whether you have specific skills or just the will to help,
                  there's a place for you. Volunteers are the backbone of our
                  programs.
                </p>
                  ...
                  {volunteerOpportunities.map((opp, i) => (
                    ...
                    >
                      <div className="flex items-start gap-4 p-5 bg-white border border-gray-100 hover:border-emerald-200 hover:shadow-lg transition-all rounded-2xl">
                        ...
                        <div>
                          <h4 className="font-bold text-[#1a1208] mb-1 text-sm sm:text-base">
                            {opp.title}
                          </h4>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  ...
                  <ul className="space-y-3">
                    {[
                      {
                        t: "Personal Growth",
                        d: "New skills and valuable experience in social work",
                      },
                      {
                        t: "Community Connection",
                        d: "Connect with like-minded change-makers",
                      },
                      {
                        t: "Certification",
                        d: "Volunteer certificate and letter of appreciation",
                      },
                      {
                        t: "Real Impact",
                        d: "Directly improve lives in underserved communities",
                      },
                    ].map((b, i) => (
                      <li key={i} className="flex items-start gap-3">
        ...
        <section className="py-16 sm:py-20 bg-[#fdf8f0]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              <div>
                <p className="text-gray-600 mb-7 leading-relaxed">
                  We welcome partnerships with organizations, corporations, and
                  institutions that share our vision of social change and
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-7">
                  {partnershipTypes.map((p, i) => (
                    <div
                      key={i}
                      className={`rounded-2xl p-5 border ${i === 0 ? "bg-[#0d2b1a] border-[#0d2b1a]" : i === 1 ? "bg-emerald-600 border-emerald-600" : "bg-white border-gray-200"}`}
                    >
                      <h4
                        className={`font-bold mb-2 text-sm ${i < 2 ? "text-white" : "text-[#1a1208]"}`}
                      >
                        {p.title}
                      </h4>
                      <p
                        className={`text-xs leading-relaxed ${i < 2 ? "text-white/70" : "text-gray-500"}`}
                      >
                        {p.text}
                      </p>
                    </div>
              ...
              <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  ...
                  <ul className="space-y-3">
                    {[
                      {
                        t: "Established Credibility",
                        d: "25+ years of proven impact",
                      },
                      {
                        t: "Scalable Impact",
                        d: "Leverage our network to scale social initiatives",
                      },
                      {
                        t: "Transparent Operations",
                        d: "Clear reporting and measurable outcomes",
                      },
                      {
                        t: "Pan-India Reach",
                        d: "Active presence across 120+ communities",
                      },
                    ].map((b, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <div className="w-5 h-5 rounded-full bg-amber-500 flex items-center justify-center flex-shrink-0 mt-0.5">
